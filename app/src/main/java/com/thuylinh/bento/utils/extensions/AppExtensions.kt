package com.thuylinh.bento.utils.extensions
...
import com.thuylinh.bento.WooBoxApp.Companion.getAppInstance
import com.thuylinh.bento.WooBoxApp.Companion.noInternetDialog
import com.thuylinh.bento.activity.DashBoardActivity
import com.thuylinh.bento.activity.ProductDetailActivityNew
import com.thuylinh.bento.models.*
import com.thuylinh.bento.utils.Constants
import com.thuylinh.bento.utils.Constants.AppBroadcasts.ADDRESS_UPDATE
import com.thuylinh.bento.utils.Constants.AppBroadcasts.CART_COUNT_CHANGE
import com.thuylinh.bento.utils.Constants.AppBroadcasts.ORDER_COUNT_CHANGE
import com.thuylinh.bento.utils.Constants.AppBroadcasts.PROFILE_UPDATE
import com.thuylinh.bento.utils.Constants.AppBroadcasts.WISHLIST_UPDATE
import com.thuylinh.bento.utils.Constants.PLAY_STORE_URL_PREFIX
import com.thuylinh.bento.utils.Constants.SharedPref.CART_DATA
import com.thuylinh.bento.utils.Constants.SharedPref.CATEGORY_DATA
import com.thuylinh.bento.utils.Constants.SharedPref.DEFAULT_CURRENCY
import com.thuylinh.bento.utils.Constants.SharedPref.IS_LOGGED_IN
import com.thuylinh.bento.utils.Constants.SharedPref.IS_SOCIAL_LOGIN
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_ADDRESS
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_CART_COUNT
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_DASHBOARD
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_ORDERS
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_RECENTS
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_USER_ADDRESS
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_WISHLIST_COUNT
import com.thuylinh.bento.utils.Constants.SharedPref.LANGUAGE
import com.thuylinh.bento.utils.Constants.SharedPref.SLIDER_IMAGES_DATA
import com.thuylinh.bento.utils.Constants.SharedPref.THEME_COLOR
import com.thuylinh.bento.utils.Constants.SharedPref.USER_DISPLAY_NAME
import com.thuylinh.bento.utils.Constants.SharedPref.USER_EMAIL
import com.thuylinh.bento.utils.Constants.SharedPref.USER_FIRST_NAME
import com.thuylinh.bento.utils.Constants.SharedPref.USER_ID
import com.thuylinh.bento.utils.Constants.SharedPref.USER_LAST_NAME
import com.thuylinh.bento.utils.Constants.SharedPref.USER_NICE_NAME
import com.thuylinh.bento.utils.Constants.SharedPref.USER_PROFILE
import com.thuylinh.bento.utils.Constants.SharedPref.USER_ROLE
import com.thuylinh.bento.utils.Constants.SharedPref.USER_TOKEN
import com.thuylinh.bento.utils.Constants.SharedPref.USER_USERNAME
import com.thuylinh.bento.utils.Constants.SharedPref.WISHLIST_DATA
...
fun Activity.cancelOrder(orderId:Int,onApiSuccess: (MyOrderData) -> Unit,onError: (String) -> Unit){
    val requestModel= RequestModel()
