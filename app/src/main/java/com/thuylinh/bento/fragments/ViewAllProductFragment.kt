...
import com.thuylinh.bento.activity.MyCartActivity
import com.thuylinh.bento.activity.SearchActivity
...
import com.thuylinh.bento.databinding.ItemNewestProductBinding
import com.thuylinh.bento.databinding.ItemViewproductgridBinding
import com.thuylinh.bento.models.FilterProductRequest
import com.thuylinh.bento.models.ProductDataNew
import com.thuylinh.bento.models.RequestModel
import com.thuylinh.bento.models.RequestModel.*
import com.thuylinh.bento.utils.Constants
import com.thuylinh.bento.utils.Constants.ViewAllCode.CATEGORY_FEATURED
import com.thuylinh.bento.utils.Constants.ViewAllCode.CATEGORY_NEWEST
...
import com.thuylinh.bento.utils.HidingScrollListener
            ...
            if (mId != CATEGORY_FEATURED && mId != CATEGORY_NEWEST) {
                ...
                filterDialog.rcvSubCategories.apply {
                    layoutManager = ChipsLayoutManager.newBuilder(activity)
                        ...
                        .setRowStrategy(ChipsLayoutManager.STRATEGY_DEFAULT).withLastRow(false)
                        .build()
                ...
                filterDialog.tv_category.hide()
                filterDialog.ll_category.hide()
            }
