package com.thuylinh.bento.fragments.home
...
import com.thuylinh.bento.activity.*
import com.thuylinh.bento.adapter.HomeSliderAdapter
import com.thuylinh.bento.adapter.RecyclerViewAdapter
import com.thuylinh.bento.base.BaseRecyclerAdapter
import com.thuylinh.bento.databinding.ItemCategoryBinding
import com.thuylinh.bento.fragments.BaseFragment
...
import com.thuylinh.bento.utils.Constants.KeyIntent.TITLE
import com.thuylinh.bento.utils.Constants.KeyIntent.VIEWALLID
import com.thuylinh.bento.utils.Constants.SharedPref.CATEGORY_DATA
import com.thuylinh.bento.utils.Constants.SharedPref.CONTACT
import com.thuylinh.bento.utils.Constants.SharedPref.COPYRIGHT_TEXT
import com.thuylinh.bento.utils.Constants.SharedPref.DEFAULT_CURRENCY
import com.thuylinh.bento.utils.Constants.SharedPref.FACEBOOK
import com.thuylinh.bento.utils.Constants.SharedPref.INSTAGRAM
import com.thuylinh.bento.utils.Constants.SharedPref.KEY_ORDER_COUNT
import com.thuylinh.bento.utils.Constants.SharedPref.PRIVACY_POLICY
import com.thuylinh.bento.utils.Constants.SharedPref.SLIDER_IMAGES_DATA
import com.thuylinh.bento.utils.Constants.SharedPref.TERM_CONDITION
import com.thuylinh.bento.utils.Constants.SharedPref.THEME_COLOR
import com.thuylinh.bento.utils.Constants.SharedPref.TWITTER
import com.thuylinh.bento.utils.Constants.SharedPref.WHATSAPP
import com.thuylinh.bento.utils.Constants.ViewAllCode.FEATURED
import com.thuylinh.bento.utils.Constants.ViewAllCode.NEWEST
import com.thuylinh.bento.utils.Constants.ViewAllCode.RECENTSEARCH
...
class HomeFragment : BaseFragment() {
    ...
    private fun setTestimonialAdapter() {
        mTestimonialsAdapter = RecyclerViewAdapter(R.layout.item_testimonial, onBind = { view, item, position ->
		    ...
		    view.ivAuthor.loadImageFromUrl("")
	    }
