...
import com.thuylinh.bento.fragments.WishListFragment
import com.thuylinh.bento.fragments.home.HomeFragment
import com.thuylinh.bento.fragments.home.HomeFragment2
import com.thuylinh.bento.models.CategoryData
...
class DashBoardActivity : AppBaseActivity() {
    ...
    public fun setOrderCount() {
        tvOrderCount.text = getSharedPrefInstance().getIntValue(KEY_ORDER_COUNT, 0).toDecimalFormat()
    }
